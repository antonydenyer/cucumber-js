var SummaryFormatter = function(options) {
	...
	var self = {
		...
		buildHandlerNameForEvent: function buildHandlerNameForEvent(event) {
			var handlerName = SummaryFormatter.EVENT_HANDLER_NAME_PREFIX + event.getName() + SummaryFormatter.EVENT_HANDLER_NAME_SUFFIX;
			return handlerName;
		},
...
SummaryFormatter.EVENT_HANDLER_NAME_PREFIX = 'handle';
SummaryFormatter.EVENT_HANDLER_NAME_SUFFIX = 'Event';
