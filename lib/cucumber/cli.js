var Cli = function(argv) {
  ...
  var self = {
    ...
    runSuiteWithConfiguration: function runSuiteWithConfiguration(configuration, callback) {
	  ...
	  console.dir(Cucumber.Listener);
      var progressFormatter = Cucumber.Listener.listeners[configuration.requestedFormatter()]();
...
\n\
                              ...
                              loaded first.\n\
\n\
-f, --format FORMATTER        Specify the output formatter to use.  If this option\n\
                              is not specified, the default progress formatter will\n\
                              be used.\n\
\n\
