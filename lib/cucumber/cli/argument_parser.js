var ArgumentParser = function(argv) {
  ...
  var self = {
    ...
    requestedFormatter: function requestedFormatter() {
        var requestedFormatter = self.getOptionOrDefault(ArgumentParser.FORMAT_OPTION_NAME, ArgumentParser.DEFAULT_FORMAT_VALUE);
        return requestedFormatter;
    },
